...
class AuthenticationResponse{
  ...
  AuthenticationResponse({required this.accessToken, required this.tokenType, required this.expiresIn, required this.refreshExpiresIn, required this.refreshToken, required this.sessionState,required this.scope});
